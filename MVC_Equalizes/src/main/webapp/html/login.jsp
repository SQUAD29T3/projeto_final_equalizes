                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse text-center" id="collapsibleNavId">
                            <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-light btn-login float-right" href="#"> LOGIN </a>
                                </li>
        ...
        <main class="login mb-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center justify-content-center">
                    ...
                    <img class="img-fluid p-5 img imgPadrao" src="../img/login.png" alt="Imagem padrão">

                    <img class="img-fluid p-5 img empresa" src="../img/empresaLogin.jpg" alt="Imagem Empresa">
                    <img class="img-fluid p-5 img escola" src="../img/escolaLogin.jpg" alt="Imagem Escola">
                ...
                <div class="col-md-6 text-center d-flex align-items-center">
                    ...
                    <form class="mt-2" action="">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <p class="parceiros" for="parceiros">Selecione o tipo de parceria:</p>

                        </div>


                        <div class="col-md-12 mt-3 mb-2 text-center d-flex justify-content-center gap-2">

                            <input type="radio" name="opc" value="escola" id="escolas" /> <label for="escolas"> Escolas </label>

                            <input type="radio" name="opc" value="empresa" id="empresas" /> <label for="empresas"> Empresas </label>
                        ...
                        <div class="col-12">
                            ...
                            <input class="mt-3" type="password" name="senha" id="senha" placeholder="Digite sua senha"
                                required>

                        </div>

                        <div class="col-12 esqueci_senha">

                            <p class="mt-2"> <a href="#"> Esqueceu sua senha? </a> </p>
